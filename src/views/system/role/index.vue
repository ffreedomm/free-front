  ...
  <div class="app-container">
    ...
    <div :style="'height: auto;max-height:' + height + 'overflow-y: auto;'">
      ...
      >
        ...
        <el-table-column align="center" prop="dataScope" label="数据权限"/>
        ...
        <el-table-column align="center" label="操作" width="150px">
          <template slot-scope="scope">
            <edit
              v-if="checkPermission(['ADMIN','ROLES_ALL','ROLES_EDIT'])"
              :data="scope.row"
              :sup_this="sup_this"
            />
            <el-popover
    ...
    <el-row :gutter="20" style="margin-top: 50px;">
      <!--权限分配-->
      <el-col :span="12">
        <el-card class="box-card" shadow="always" header="background-color: #409eff">
          <div slot="header" class="clearfix">
            <span class="el-card-span">权限分配</span>
            <el-button
      ...
      <el-col :span="12">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <span class="el-card-span">菜单分配</span>
            <el-button
              v-if="showButton && checkPermission(['ADMIN','ROLES_ALL','ROLES_EDIT'])"
              :loading="menuLoading"
              icon="el-icon-check"
